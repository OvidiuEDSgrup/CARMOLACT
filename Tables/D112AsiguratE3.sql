...
GO
CREATE NONCLUSTERED INDEX [missing_index_1425]
    ON [dbo].[D112AsiguratE3]([Data] ASC, [E3_3] ASC)
    INCLUDE([Loc_de_munca], [cnpAsig], [E3_8], [E3_9], [E3_11], [E3_12], [E3_13], [E3_14], [E3_15]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1427]
    ON [dbo].[D112AsiguratE3]([Data] ASC, [E3_3] ASC)
    INCLUDE([Loc_de_munca], [cnpAsig], [E3_8], [E3_9], [E3_14], [E3_15]);
