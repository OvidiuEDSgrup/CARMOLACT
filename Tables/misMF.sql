CREATE TABLE [dbo].[misMF] (
    ...
    [Subunitate_primitoare]   CHAR (20)    NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [missing_index_371]
    ON [dbo].[misMF]([Subunitate] ASC, [Numar_de_inventar] ASC, [Data_lunii_de_miscare] ASC, [Tip_miscare] ASC, [Data_miscarii] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_299]
    ON [dbo].[misMF]([Subunitate] ASC, [Numar_de_inventar] ASC)
    INCLUDE([Tip_miscare]);
