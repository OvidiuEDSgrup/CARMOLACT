CREATE TABLE [dbo].[pozdoc] (
    ...
    [Data_operarii]         DATETIME2 (5) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [missing_index_164]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cont_de_stoc] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cod], [Contract], [idPozDoc], [detalii], [Numar_DVI], [Valuta], [Curs], [Data_facturii], [Data_scadentei], [Procent_vama], [Numar_pozitie], [Loc_de_munca], [Comanda], [Barcod], [Discount], [Tert], [Cantitate], [Pret_valuta], [Pret_vanzare], [TVA_deductibil], [Cod_intrare], [Cont_corespondent]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1501]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tert] ASC, [Factura] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1217]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC, [Data] ASC, [Comanda] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1037]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC, [Cod] ASC, [Data] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_898]
    ON [dbo].[pozdoc]([Numar] ASC, [Data] ASC, [Tert] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1039]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC, [Cod] ASC, [Data] ASC, [Cantitate] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1126]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC, [Gestiune] ASC, [Gestiune_primitoare] ASC)
    INCLUDE([Cod], [Cantitate]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1091]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tip] ASC, [Cod] ASC, [Cod_intrare] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1191]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC, [Gestiune] ASC)
    INCLUDE([Cantitate], [Pret_cu_amanuntul]);
...
GO
CREATE NONCLUSTERED INDEX [missing_index_902]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC)
    INCLUDE([Gestiune]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1207]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC)
    INCLUDE([Cod], [Cantitate], [Pret_cu_amanuntul]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1312]
    ON [dbo].[pozdoc]([Numar] ASC, [Data] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1299]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tert] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cod], [Factura], [Cantitate], [Pret_de_stoc], [Pret_vanzare], [TVA_deductibil], [Numar_pozitie], [Comanda]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1316]
    ON [dbo].[pozdoc]([Data] ASC)
    INCLUDE([Numar]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1028]
    ON [dbo].[pozdoc]([Tip] ASC, [Numar] ASC, [Cod] ASC, [Data] ASC)
    INCLUDE([Cod_intrare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_25]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Contract] ASC, [Tip] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1030]
    ON [dbo].[pozdoc]([Tip] ASC)
    INCLUDE([Numar], [Cod], [Data], [Cod_intrare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_27]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Tip] ASC)
    INCLUDE([Cantitate], [Factura], [Grupa]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1762]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Gestiune] ASC, [Tip_miscare] ASC, [Data] ASC)
    INCLUDE([Tip], [Numar], [Loc_de_munca], [Comanda], [Cod_intrare], [Cont_de_stoc], [Cont_corespondent], [TVA_neexigibil], [Pret_amanunt_predator], [Numar_pozitie], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Utilizator], [Data_operarii], [Ora_operarii], [Cod], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos], [Pret_vanzare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_3057]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Factura] ASC, [Tip] ASC, [Data] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_81]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Gestiune] ASC, [Factura] ASC, [Tip] ASC, [Data] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_3130]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tip] ASC, [Cod] ASC, [Gestiune] ASC, [Data] ASC, [Locatie] ASC)
    INCLUDE([Comanda], [TVA_neexigibil], [Pret_amanunt_predator], [Tip_miscare], [Data_expirarii], [Numar_pozitie], [Loc_de_munca], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Cod_intrare], [Cont_de_stoc], [Cont_corespondent], [Numar], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos], [Pret_vanzare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1224]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cod], [Cantitate], [Tert]);


GO
CREATE NONCLUSTERED INDEX [missing_index_3081]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cantitate], [Factura], [Pret_de_stoc], [Pret_vanzare], [TVA_deductibil], [Numar_pozitie], [Comanda], [Tert]);


GO
CREATE NONCLUSTERED INDEX [missing_index_3084]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Gestiune] ASC, [Tip_miscare] ASC, [Data] ASC)
    INCLUDE([Tip], [Loc_de_munca], [Comanda], [Cod_intrare], [Cont_de_stoc], [Cont_corespondent], [TVA_neexigibil], [Pret_amanunt_predator], [Numar_pozitie], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Utilizator], [Data_operarii], [Ora_operarii], [Numar], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos], [Pret_vanzare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_580]
    ON [dbo].[pozdoc]([Cod] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_3030]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tert] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Cod], [Cantitate], [Curs], [Pret_valuta], [Pret_de_stoc], [Pret_vanzare], [Cont_de_stoc], [Tip_miscare], [Valuta]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1216]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tip] ASC, [Data] ASC, [Comanda] ASC)
    INCLUDE([Cod]);


GO
CREATE NONCLUSTERED INDEX [missing_index_6134]
    ON [dbo].[pozdoc]([Cod_intrare] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_3915]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Gestiune] ASC, [Tip_miscare] ASC, [Data] ASC)
    INCLUDE([Tip], [Jurnal], [Data_scadentei], [Procent_vama], [Suprataxe_vama], [Accize_cumparare], [Accize_datorate], [Contract], [Stare], [Grupa], [Cont_factura], [Valuta], [Curs], [Data_facturii], [Cont_venituri], [Discount], [Tert], [Factura], [Gestiune_primitoare], [Numar_DVI], [Data_expirarii], [Numar_pozitie], [Loc_de_munca], [Comanda], [Barcod], [Cont_intermediar], [Cod_intrare], [Cont_de_stoc], [Cont_corespondent], [TVA_neexigibil], [Pret_amanunt_predator], [Locatie], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Utilizator], [Data_operarii], [Ora_operarii], [Numar], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos], [Pret_vanzare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_5087]
    ON [dbo].[pozdoc]([Loc_de_munca] ASC)
    INCLUDE([Data], [Cantitate]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1906]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Data] ASC, [Cont_de_stoc] ASC)
    INCLUDE([Tip], [Gestiune], [Curs], [Jurnal], [Loc_de_munca], [Tert], [Factura], [Numar_DVI], [Cont_factura], [Valuta], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Pret_vanzare], [Cod_intrare], [Tip_miscare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_4129]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cod], [Gestiune], [Cantitate], [Comanda], [Tert], [Factura], [Numar_DVI], [Pret_de_stoc], [Adaos], [Pret_vanzare], [TVA_deductibil], [Numar_pozitie], [Loc_de_munca]);


GO
CREATE NONCLUSTERED INDEX [missing_index_3936]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC)
    INCLUDE([Subunitate], [Numar], [Cod], [Gestiune], [Loc_de_munca], [Comanda], [Tert], [Factura], [Numar_DVI], [Cont_factura], [Cantitate], [Pret_de_stoc], [Pret_vanzare], [Cod_intrare], [Cont_corespondent], [Numar_pozitie]);


GO
CREATE NONCLUSTERED INDEX [missing_index_126]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tert] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Numar], [Cod], [Contract], [Jurnal], [Loc_de_munca], [Comanda], [Barcod], [Factura], [Cont_factura], [Valuta], [Cota_TVA], [Cod_intrare], [Cont_de_stoc], [Tip_miscare], [Locatie], [Numar_pozitie], [Gestiune], [Cantitate], [Pret_de_stoc], [Pret_vanzare], [Pret_cu_amanuntul], [TVA_deductibil]);


GO
CREATE NONCLUSTERED INDEX [missing_index_109]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod] ASC, [Loc_de_munca] ASC, [Tip] ASC, [Data] ASC)
    INCLUDE([Gestiune], [Cantitate], [Pret_de_stoc], [Cod_intrare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1908]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Data] ASC, [Cont_de_stoc] ASC)
    INCLUDE([Tip], [Cod], [Gestiune], [Curs], [Jurnal], [Loc_de_munca], [Tert], [Factura], [Numar_DVI], [Cont_factura], [Valuta], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Pret_vanzare], [Cod_intrare], [Tip_miscare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1003]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tip] ASC, [Gestiune] ASC, [Data] ASC, [Locatie] ASC)
    INCLUDE([Numar], [Comanda], [TVA_neexigibil], [Pret_amanunt_predator], [Tip_miscare], [Data_expirarii], [Numar_pozitie], [Loc_de_munca], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Cod_intrare], [Cont_de_stoc], [Cont_corespondent], [Cod], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos], [Pret_vanzare]);


GO
CREATE NONCLUSTERED INDEX [missing_index_324]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Cod_intrare] ASC)
    INCLUDE([Data], [Jurnal]);


GO
CREATE NONCLUSTERED INDEX [missing_index_267]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC, [Data_operarii] ASC, [Ora_operarii] ASC)
    INCLUDE([Subunitate], [Numar], [idIntrareTI], [lot], [colet], [Jurnal], [idPozDoc], [detalii], [subtip], [idIntrareFirma], [idIntrare], [Data_scadentei], [Procent_vama], [Suprataxe_vama], [Accize_cumparare], [Accize_datorate], [Contract], [Stare], [Grupa], [Cont_factura], [Valuta], [Curs], [Data_facturii], [Cont_venituri], [Discount], [Tert], [Factura], [Gestiune_primitoare], [Numar_DVI], [Data_expirarii], [Numar_pozitie], [Loc_de_munca], [Comanda], [Barcod], [Cont_intermediar], [Cont_de_stoc], [Cont_corespondent], [TVA_neexigibil], [Pret_amanunt_predator], [Tip_miscare], [Locatie], [Pret_vanzare], [Pret_cu_amanuntul], [TVA_deductibil], [Cota_TVA], [Utilizator], [Cod_intrare], [Cod], [Gestiune], [Cantitate], [Pret_valuta], [Pret_de_stoc], [Adaos]);


GO
CREATE NONCLUSTERED INDEX [missing_index_269]
    ON [dbo].[pozdoc]([Tip] ASC, [Data] ASC, [Data_operarii] ASC, [Gestiune_primitoare] ASC, [Ora_operarii] ASC)
    INCLUDE([Subunitate], [Numar], [Numar_pozitie]);


GO
CREATE NONCLUSTERED INDEX [missing_index_875]
    ON [dbo].[pozdoc]([Subunitate] ASC, [Tip] ASC, [Cod] ASC, [Tip_miscare] ASC, [Gestiune_primitoare] ASC)
    INCLUDE([Numar], [Data], [Cod_intrare], [Cont_corespondent], [Pret_amanunt_predator], [Numar_pozitie], [Grupa]);
...
GO
--***
create trigger docctatr on dbo.pozdoc for insert, update
as
declare @msgErr varchar(1000), @tip varchar(2), @numar varchar(20), @data datetime,@cont varchar(20)
if (
(select count(cont_factura) from inserted i inner join conturi c on i.cont_factura=c.cont 
where i.tip in ('RM','RS','RP') and sold_credit<>1)>0)
begin
	select @tip=tip, @numar=numar, @data=data,@cont=i.Cont_factura 
		from inserted i 
		inner join conturi c on i.cont_factura=c.cont 
		where i.tip in ('RM','RS','RP') and sold_credit<>1
	set @msgErr='Eroare: Contul facturii ('+rtrim(@cont)+') trebuie sa fie atribuit furnizori, document: '+@tip+' '+@numar+' din '+convert(char(10),@data,103)+'(pozdoc.docctatr)'
	RAISERROR (@msgErr, 16, 1)
	rollback transaction 
end
if (select count(cont_factura) from inserted i inner join conturi c on i.cont_factura=c.cont where i.tip in ('AP','AS') and sold_credit<>2)>0
begin
	select @tip=tip, @numar=numar, @data=data 
		from inserted i 
		inner join conturi c on i.cont_factura=c.cont 
		where i.tip in ('AP','AS') and sold_credit<>2
	set @msgErr='Eroare: Contul facturii trebuie sa fie atribuit beneficiari, document: '+@tip+' '+@numar+' din '+convert(char(10),@data,103)+'(pozdoc.docctatr)'
	RAISERROR (@msgErr, 16, 1)
	rollback transaction 
end
if (select count(cont_corespondent) from inserted i inner join conturi c on i.cont_corespondent=c.cont where i.tip in ('AE','AC','AI','CM','AP') and tip_miscare<>'V' and sold_credit<>0)>0
begin
	select @tip=tip, @numar=numar, @data=data 
		from inserted i 
		inner join conturi c on i.cont_corespondent=c.cont 
		where i.tip in ('AE','AC','AI','CM','AP') and tip_miscare<>'V' and sold_credit<>0
	set @msgErr='Eroare: Contul corespondent nu poate fi atribuit, document: '+@tip+' '+@numar+' din '+convert(char(10),@data,103)+'(pozdoc.docctatr)'
	RAISERROR (@msgErr, 16, 1)
	rollback transaction 
end
if (select count(cont_corespondent) from inserted i inner join conturi c on i.cont_corespondent=c.cont inner join gestiuni g on i.Gestiune_primitoare=g.Cod_gestiune where i.tip ='TE' and sold_credit<>3 and g.Tip_gestiune not in ('I','V') and i.cont_corespondent not like '482%' and i.cont_de_stoc not like '8%')>0
begin
	select @tip=tip, @numar=numar, @data=data,@cont=rtrim(i.cont_corespondent)
		from inserted i 
		inner join conturi c on i.cont_corespondent=c.cont 
		inner join gestiuni g on i.Gestiune_primitoare=g.Cod_gestiune
		where i.tip ='TE' and sold_credit<>3 and g.Tip_gestiune<>'I' and i.cont_corespondent not like '482%' and i.cont_de_stoc not like '8%'
	set @msgErr='Eroare: Contul corespondent al transferului ('+@cont+') trebuie sa fie atribuit 3-Stocuri, document: '+@tip+' '+@numar+' din '+convert(char(10),@data,103)+'(pozdoc.docctatr)'
	RAISERROR (@msgErr, 16, 1)
	rollback transaction 
end
if (select count(cont_de_stoc) from inserted i inner join conturi c on i.cont_de_stoc=c.cont where sold_credit not in (0, 3, 4) and tip_miscare<>'V' and i.cont_de_stoc not like '482%')>0
begin
	select @tip=tip, @numar=numar, @data=data 
		from inserted i 
		inner join conturi c on i.cont_de_stoc=c.cont 
		where sold_credit not in (0, 3, 4) and tip_miscare<>'V' and i.cont_de_stoc not like '482%'
	set @msgErr='Eroare: Contul de stoc trebuie sa fie atribuit 3-Stocuri, document: '+@tip+' '+@numar+' din '+convert(char(10),@data,103)+'(pozdoc.docctatr)'
	RAISERROR (@msgErr, 16, 1)
	rollback transaction 
end
...
create trigger docantet on dbo.pozdoc for update,insert,delete as
begin
...
insert into doc 
	...
	max(case when tip='RM' and numar_DVI<>'' then 0 else Procent_vama end), 0,/*max(discount)*/ max(accize_cumparare),0,min(tip_miscare), 
...
GO
--***
create trigger docdec on dbo.pozdoc for insert, update, delete as
begin
insert deconturi
...
GO
create trigger docfac on dbo.pozdoc for update,insert,delete as
begin try
-------------	din tabela par (parametri trimis de Magic):
...
GO
--***
create trigger docfacav on dbo.pozdoc for update,insert,delete as
begin
...
create trigger docstoc on dbo.pozdoc for insert,update,delete as
begin try
-------------	din tabela par (parametri trimis de Magic):
...
GO
--***
CREATE trigger pozdocsterg on dbo.pozdoc for update, delete NOT FOR REPLICATION as
...
begin try	
	...
	*/
	...
	IF EXISTS (select 1 from inserted where tip not in ('RP','RZ','MI') and (tip<>'RM' and ISNULL(Pret_vanzare,0.0)<0 or ISNULL(Pret_valuta,0.0)<0 or ISNULL(Pret_cu_amanuntul,0.0)<0 OR ISNULL(Pret_de_stoc,0.0)<0))
		RAISERROR ('Nu este permisa operarea cu preturi negative', 16, 1)

	/* Validare tert */
	if UPDATE(tert) 
	begin
		select DISTINCT tert as cod, Data as data into #terti 
		from inserted where tip in ('RM','RS','RP','AP','AS') and subunitate<>'intrastat'
		exec validTert
	end 
	...
	BEGIN
		create table #formulecontabile (cont_debit varchar(40), cont_credit varchar(40), tip varchar(2), numar varchar(40), data datetime)
	...
	*/
	...
	if (select count(*) from inserted where data<@dDatastoc and Tip_miscare in ('I','E'))>0 or (select count(*) from deleted where data<@dDatastoc and Tip_miscare in ('I','E'))>0
		RAISERROR ('Violare integritate date. Incercare de modificare luna initializata stocuri ', 16, 1)

	/** Validare luna inchisa Contabilitate */
	create table #lunaconta (data datetime, lm varchar(20))
	insert into #lunaconta (data, lm)
	select DISTINCT data, loc_de_munca from inserted where tip<>'MI' -- imobilizari la implementare
	union all
	select DISTINCT data, loc_de_munca from deleted where tip<>'MI'
	...
	if ISNULL(left(cast(CONTEXT_INFO() as varchar),19),'')<>'anularedocdefinitiv' -- pana o sa avem alta solutie de documente anulate
			and ISNULL(left(cast(CONTEXT_INFO() as varchar),22),'')<>'modificaredocdefinitiv'
	begin
		if object_id('tempdb..#jurnalDoc') is not null drop table #jurnalDoc
		select JD.stare, JD.tip, JD.numar, JD.data, JD.data_operatii, JD.idJurnal 
			into #jurnalDoc
			from JurnalDocumente JD
			where exists (select 1 from (select * from INSERTED union all select * from deleted) ins where ins.Subunitate='1' and ins.tip=jd.tip and ins.numar=jd.numar and ins.data=JD.data)

		IF EXISTS (select 1	from 
			(select stare,tip, numar, data,RANK() over (PARTITION by tip, numar, data order BY data_operatii desc, idJurnal desc) rn  from #jurnalDoc) JD 
			JOIN StariDocumente sd on sd.TipDocument=jd.tip and sd.stare=jd.stare 
			where sd.modificabil=0 and jd.rn=1) 
