CREATE TABLE [dbo].[pozincon] (
    ...
    [Indbug]         VARCHAR (20)  CONSTRAINT [DF__pozincon__Indbug__7F9FB161] DEFAULT ('') NOT NULL,
    CONSTRAINT [PK_PozInCon] PRIMARY KEY CLUSTERED ([Subunitate] ASC, [Tip_document] ASC, [Numar_document] ASC, [Data] ASC, [Cont_debitor] ASC, [Cont_creditor] ASC, [Loc_de_munca] ASC, [Comanda] ASC, [Valuta] ASC, [Numar_pozitie] ASC) ON [SYNTHESIS]
);
...
GO
CREATE NONCLUSTERED INDEX [missing_index_283]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC, [Cont_debitor] ASC)
    INCLUDE([Suma], [Loc_de_munca])
    ON [SYNTHESIS];
...
CREATE NONCLUSTERED INDEX [missing_index_260]
    ON [dbo].[pozincon]([Subunitate] ASC, [Cont_creditor] ASC, [Data] ASC)
    INCLUDE([Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];


GO
CREATE NONCLUSTERED INDEX [missing_index_255]
    ON [dbo].[pozincon]([Subunitate] ASC, [Cont_debitor] ASC, [Data] ASC)
    INCLUDE([Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];
...
CREATE NONCLUSTERED INDEX [missing_index_262]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC)
    INCLUDE([Cont_creditor], [Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];
...
CREATE NONCLUSTERED INDEX [missing_index_258]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC)
    INCLUDE([Cont_debitor], [Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];


GO
CREATE NONCLUSTERED INDEX [missing_index_742]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC, [Cont_debitor] ASC, [Valuta] ASC)
    INCLUDE([Suma_valuta], [Loc_de_munca])
    ON [SYNTHESIS];


GO
CREATE NONCLUSTERED INDEX [missing_index_6]
    ON [dbo].[pozincon]([Subunitate] ASC, [Cont_creditor] ASC, [Data] ASC)
    INCLUDE([Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];
...
GO
CREATE NONCLUSTERED INDEX [missing_index_10]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC, [Cont_creditor] ASC)
    INCLUDE([Suma], [Loc_de_munca])
    ON [SYNTHESIS];
...
GO
CREATE NONCLUSTERED INDEX [missing_index_4]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC)
    INCLUDE([Cont_debitor], [Suma], [Valuta], [Suma_valuta], [Loc_de_munca], [Jurnal])
    ON [SYNTHESIS];
...
CREATE NONCLUSTERED INDEX [missing_index_974]
    ON [dbo].[pozincon]([Subunitate] ASC, [Data] ASC)
    INCLUDE([Tip_document], [Numar_document], [Cont_debitor], [Cont_creditor], [Suma], [Explicatii], [Loc_de_munca])
    ON [SYNTHESIS];
