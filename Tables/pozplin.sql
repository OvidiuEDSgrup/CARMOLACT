...
CREATE NONCLUSTERED INDEX [missing_index_160]
    ON [dbo].[pozplin]([tip_tva] ASC, [Plata_incasare] ASC, [Curs_la_valuta_facturii] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_285]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC)
    INCLUDE([Loc_de_munca]);


GO
CREATE NONCLUSTERED INDEX [missing_index_287]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC)
    INCLUDE([Plata_incasare], [Suma], [Loc_de_munca]);


GO
CREATE NONCLUSTERED INDEX [missing_index_919]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont_corespondent] ASC, [Data] ASC, [Plata_incasare] ASC)
    INCLUDE([Numar], [Tert], [Suma], [efect]);


GO
CREATE NONCLUSTERED INDEX [missing_index_911]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont_corespondent] ASC, [Data] ASC, [Plata_incasare] ASC)
    INCLUDE([Numar], [Tert], [Suma], [Loc_de_munca], [efect]);


GO
CREATE NONCLUSTERED INDEX [missing_index_272]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Numar_pozitie] ASC, [Jurnal] ASC, [Numar] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_1174]
    ON [dbo].[pozplin]([Subunitate] ASC, [Plata_incasare] ASC, [Data] ASC, [Cont_corespondent] ASC)
    INCLUDE([Suma], [TVA22]);


GO
CREATE NONCLUSTERED INDEX [missing_index_7]
    ON [dbo].[pozplin]([Subunitate] ASC, [Numar] ASC);
...
GO
CREATE NONCLUSTERED INDEX [missing_index_67]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Numar] ASC, [Plata_incasare] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_5881]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Numar] ASC, [Numar_pozitie] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_6183]
    ON [dbo].[pozplin]([Subunitate] ASC, [Tert] ASC, [Loc_de_munca] ASC, [Data] ASC, [Plata_incasare] ASC)
    INCLUDE([Cont], [Numar], [Factura], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [TVA11], [TVA22], [Explicatii], [Comanda], [Numar_pozitie], [Achit_fact], [Jurnal]);


GO
CREATE NONCLUSTERED INDEX [missing_index_267]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Jurnal] ASC, [Plata_incasare] ASC, [Valuta] ASC, [Suma_valuta] ASC)
    INCLUDE([Numar], [Curs], [Numar_pozitie], [Cont_dif]);


GO
CREATE NONCLUSTERED INDEX [missing_index_3978]
    ON [dbo].[pozplin]([Subunitate] ASC, [Loc_de_munca] ASC, [Data] ASC, [Plata_incasare] ASC)
    INCLUDE([Cont], [Numar], [Tert], [Factura], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [TVA11], [TVA22], [Explicatii], [Comanda], [Numar_pozitie], [Achit_fact], [Jurnal]);


GO
CREATE NONCLUSTERED INDEX [missing_index_717]
    ON [dbo].[pozplin]([Subunitate] ASC, [Loc_de_munca] ASC, [Cont] ASC, [Data] ASC)
    INCLUDE([Numar], [Plata_incasare], [Tert], [Factura], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [TVA11], [TVA22], [Explicatii], [Comanda], [Numar_pozitie], [Achit_fact], [Jurnal]);


GO
CREATE NONCLUSTERED INDEX [missing_index_4337]
    ON [dbo].[pozplin]([Subunitate] ASC, [Loc_de_munca] ASC, [Cont] ASC, [Data] ASC, [Plata_incasare] ASC)
    INCLUDE([Numar], [Tert], [Factura], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [TVA11], [TVA22], [Explicatii], [Comanda], [Numar_pozitie], [Achit_fact], [Jurnal]);


GO
CREATE NONCLUSTERED INDEX [missing_index_69]
    ON [dbo].[pozplin]([Plata_incasare] ASC)
    INCLUDE([Subunitate], [Cont], [Data], [Numar]);


GO
CREATE NONCLUSTERED INDEX [missing_index_274]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Jurnal] ASC, [Numar_pozitie] ASC)
    INCLUDE([Numar], [Plata_incasare], [Tert], [Factura], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [Curs_la_valuta_facturii], [TVA11], [TVA22], [Explicatii], [Loc_de_munca], [Comanda], [Utilizator], [Data_operarii], [Ora_operarii], [Cont_dif], [Suma_dif], [Achit_fact], [detalii], [tip_tva], [marca], [decont], [efect]);


GO
CREATE NONCLUSTERED INDEX [missing_index_2045]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Loc_de_munca] ASC)
    INCLUDE([Plata_incasare], [Tert], [Cont_corespondent], [Suma], [Valuta], [Curs], [Suma_valuta], [Jurnal], [efect]);


GO
CREATE NONCLUSTERED INDEX [missing_index_2073]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont_corespondent] ASC, [Data] ASC, [Utilizator] ASC, [Jurnal] ASC)
    INCLUDE([Cont], [Numar], [Plata_incasare], [Tert], [Factura], [Suma], [Valuta], [Curs], [Suma_valuta], [Explicatii], [Loc_de_munca], [Numar_pozitie], [idPozPlin]);


GO
CREATE NONCLUSTERED INDEX [missing_index_4225]
    ON [dbo].[pozplin]([Subunitate] ASC, [Plata_incasare] ASC, [Loc_de_munca] ASC, [Data] ASC)
    INCLUDE([Tert], [Factura], [Suma]);


GO
CREATE NONCLUSTERED INDEX [missing_index_4227]
    ON [dbo].[pozplin]([Subunitate] ASC, [Plata_incasare] ASC, [Data] ASC)
    INCLUDE([Tert], [Factura], [Suma], [Loc_de_munca]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1096]
    ON [dbo].[pozplin]([Subunitate] ASC, [Data] ASC)
    INCLUDE([Cont], [Numar], [Tert], [decont], [efect], [idPozPlin]);


GO
CREATE NONCLUSTERED INDEX [missing_index_41]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Numar] ASC, [Plata_incasare] ASC);


GO
CREATE NONCLUSTERED INDEX [missing_index_192]
    ON [dbo].[pozplin]([Subunitate] ASC, [Cont] ASC, [Data] ASC, [Jurnal] ASC, [Plata_incasare] ASC, [Valuta] ASC, [Suma_valuta] ASC)
    INCLUDE([Numar], [Curs], [Numar_pozitie], [Cont_dif]);


GO
CREATE NONCLUSTERED INDEX [missing_index_43]
    ON [dbo].[pozplin]([Plata_incasare] ASC)
    INCLUDE([Subunitate], [Cont], [Data], [Numar]);


GO
CREATE NONCLUSTERED INDEX [missing_index_86]
    ON [dbo].[pozplin]([Subunitate] ASC, [Plata_incasare] ASC, [Data] ASC, [Explicatii] ASC)
    INCLUDE([Cont], [Numar], [Cont_corespondent], [Suma], [Loc_de_munca], [Comanda], [Numar_pozitie], [idPozPlin]);


GO
CREATE NONCLUSTERED INDEX [missing_index_84]
    ON [dbo].[pozplin]([Subunitate] ASC, [Data] ASC, [Plata_incasare] ASC, [Numar] ASC, [Explicatii] ASC)
    INCLUDE([Cont]);
...
begin try
	...
	if UPDATE(marca) 
	begin
		select DISTINCT i.marca, i.data, i.decont into #marci 
		from inserted i
			left outer join conturi c on c.cont=i.cont
			left outer join conturi cc on cc.cont=i.cont_corespondent
		where c.Sold_credit='9' or cc.Sold_credit='9'

		if exists (select 1 from #marci where nullif(decont,'') is null) and isnull((select top 1 val_logica from par where tip_parametru='GE' and parametru='DECMARCT'),0)=0
	...
	select DISTINCT data, loc_de_munca from inserted
	union all
	select DISTINCT data, loc_de_munca from deleted
