...
GO
CREATE NONCLUSTERED INDEX [missing_index_1414]
    ON [dbo].[istPers]([Data] ASC, [Grupa_de_munca] ASC, [Tip_colab] ASC)
    INCLUDE([Marca], [Loc_de_munca]);


GO
CREATE NONCLUSTERED INDEX [missing_index_1416]
    ON [dbo].[istPers]([Data] ASC, [Grupa_de_munca] ASC)
    INCLUDE([Marca], [Loc_de_munca]);
