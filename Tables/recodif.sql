...
GO
CREATE NONCLUSTERED INDEX [missing_index_1722]
    ON [dbo].[recodif]([Tip] ASC, [Alfa2] ASC, [Alfa3] ASC, [Alfa4] ASC, [Alfa5] ASC, [Alfa6] ASC, [Alfa7] ASC, [Alfa8] ASC, [Alfa9] ASC, [Alfa10] ASC)
    INCLUDE([Identificator], [Alfa1]);
