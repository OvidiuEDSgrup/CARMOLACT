...
GO
CREATE NONCLUSTERED INDEX [missing_index_346]
    ON [dbo].[MFix]([Subunitate] ASC, [Tip_amortizare] ASC)
    INCLUDE([Numar_de_inventar]);


GO
CREATE NONCLUSTERED INDEX [_dta_index_MFix_8_805577908__K2_K1_3]
    ON [dbo].[MFix]([Numar_de_inventar] ASC, [Subunitate] ASC)
    INCLUDE([Denumire]);


GO
CREATE NONCLUSTERED INDEX [missing_index_314]
    ON [dbo].[MFix]([Subunitate] ASC, [Cod_de_clasificare] ASC);
