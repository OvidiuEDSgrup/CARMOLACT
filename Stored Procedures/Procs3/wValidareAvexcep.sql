--***
Create procedure wValidareAvexcep (@sesiune varchar(50), @document xml)
as 
begin
	declare @subtip varchar(2), @data datetime, @marca varchar(6), @lmantet varchar(9), @lmsal varchar(9),
	@Plecat int, @Data_plec datetime, @mesaj varchar(200), @DateSalGrpPeLMNivel1 int
	...
	--	return -1
	--end
	if @document.exist('/row/row')=1 and @lmsal<>@lmantet and @DateSalGrpPeLMNivel1=0 --and @subtip='A2'
	begin
