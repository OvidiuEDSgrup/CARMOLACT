...
begin try
	...
	begin	
		...
		begin
			...
			if not exists (select 1 from mismf where subunitate=@subunitate and Data_lunii_de_miscare=dbo.EOM(@data) and Tip_miscare in ('EAE','MEP') and Numar_de_inventar=@nrinv)
			begin
