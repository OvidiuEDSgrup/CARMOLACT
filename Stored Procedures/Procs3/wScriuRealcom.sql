--***
Create procedure wScriuRealcom @sesiune varchar(50), @parXML xml 
as
...
begin try
	...
	begin
		...
		if @ptupdate=0 and @marca<>'' and @tip='AI' and @loc_de_munca=''
			select @loc_de_munca=@loc_de_munca from personal where Marca=@marca
