...
AS
DECLARE @idRes INT, @idOpRes INT, @codOpRes VARCHAR(16), @capacitateOpRes FLOAT, @update BIT
...
IF @capacitateOpRes = 0
	OR @codOpRes = ''
BEGIN
	RAISERROR ('(wScriuOperatiiResursa)Cod necompletat sau capacitate introdusa egala cu zero!', 11, 1)
