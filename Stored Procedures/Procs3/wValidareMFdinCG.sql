...
begin
	...
	where p.subunitate=@subunitate and Tip=@tip and Numar=@numar and Data=@data and subtip='MF'
		and (@subtip in ('RP','DV') or @numarpozitie is null or p.Numar_pozitie=@numarpozitie)
	--Dorin: a sters o pozitie dintr-o RM mai mare, nu poate s-o introduca din nou pt.ca da 
	--mesaj ca "...s-a inceput amortizarea" => din cauza ca vede celelalte MF de pe receptie
		and p.Cod_intrare=@nrinv
