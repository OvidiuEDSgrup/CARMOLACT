	...
	EXEMPLU APEL 
		exec yso_rapFactura_teste @sesiune='',@tip='AP', @numar='16106639', @data='2016-10-25', @nrexemplare=1
	*/
CREATE procedure [dbo].[yso_rapFactura_teste] (@sesiune varchar(50)=null, @tip varchar(2), @numar varchar(20), @data datetime, @nrExemplare int=1,
...
begin try
	...
	*/
	...
	select 
		...
		isnull(ISNULL(rtrim(j2.denumire) ,RTRIM(inf.telefon_fax2))
	...
	left join judete j2 on j2.cod_judet=inf.telefon_fax2
