...
@docXML xml, @docXMLIaDLSalarii xml, @eroare xml, @mesaj varchar(254), @ptupdate int, @dataj datetime, @datas datetime, @detalii xml
...
begin try
	...
	select isnull(tip, '') as tip, 
		...
		isnull(ptupdate,0) as ptupdate, detalii
	...
	@Procent_progr_la_lichidare, @explicatii, @densalariat, @denlm, @denfunctie, @salarincadrare, @ptupdate, @detalii
	...
	begin
		...
		exec scriuResal 
			@data, @marca, @Cod_beneficiar, @Numar_document, @Data_document, @Valoare_totala_pe_doc, 0, 
			@Retinere_progr_la_avans, @Retinere_progr_la_lichidare, @Procent_progr_la_lichidare, 0, 0, @detalii
