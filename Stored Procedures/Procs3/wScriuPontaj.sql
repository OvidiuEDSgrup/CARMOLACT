...
@comanda varchar(20), @nrtichete decimal(12,2)
...
begin try
	...
	(
		...
		nrtichete decimal(12,2) '@nrtichete'
	) a
...
-->	daca adaugare atunci sa faca isnull pe variabile. Altfel sa ramina null si daca null sa ramina ce este in tabela	
	...
	@coef_de_timp=(case when @subtip='XX' then @nrtichete else @k end),
	...
	@o_cond_6=(case when @subtip in ('P1','P2') then @nrtichete else @k end),--tichet de masa
