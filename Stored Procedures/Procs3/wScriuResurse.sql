create procedure [dbo].[wScriuResurse]  @sesiune varchar(50), @parXML XML  
as
	declare		
	...
	if @tipRes = '' or @codRes= ''
	begin
		raiserror('(wScriuResurse)Existe elemente cu valori necompletate!',11,1)
		return -1
	end
	...
	begin
		...
		if @update=1
		begin
			update resurse set descriere =@descriereRes , detalii=@detalii where id=@idRes
		end
