...
begin try
	select identity (int, 1, 1) as numar_unic, isnull(ptupdate, 0) as ptupdate, upper(tert) as tert, isnull(tert_vechi, tert) as tert_vechi, 
		...
		lm as lm, persoana_contact, nume_delegat, upper(serie_buletin) as serie_buletin, upper(numar_buletin) as numar_buletin, upper(eliberat_buletin) as eliberat_buletin, 
