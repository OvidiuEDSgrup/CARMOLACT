--***
Create procedure wStergTichete @sesiune varchar(50), @parXML xml
as
...
begin try
	...
	where a.Data_lunii=dx.Data and a.Marca=dx.Marca 
	and (a.Tip_operatie=dx.Tip_operatie and a.Serie_inceput=dx.Serie_inceput and dx.subtip in ('T1','T2') or dx.subtip='TC')
