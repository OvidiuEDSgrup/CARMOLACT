...
begin
	...
	if @document.exist('/row/row')=1 and @tipdiagnostic='6-' and len(rtrim(isnull(@document.value('(/row/row/@codurgenta)[1]', 'varchar(10)'), '')))>3
	begin
		raiserror('Cod urgenta trebuie sa aiba maxim 3 caractere cate se declara in declaratia 112!',11,1)
		return -1
	end
	...
	if @document.exist('/row/row')=1 and @tipdiagnostic='5-' and len(rtrim(isnull(@document.value('(/row/row/@codgrupaa)[1]', 'varchar(10)'), '')))>2
	begin
		raiserror('Cod grupa A trebuie sa aiba maxim 2 caractere cate se declara in declaratia 112!',11,1)
		return -1
	end
