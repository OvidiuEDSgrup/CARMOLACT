--***
Create procedure wValidareTichete (@sesiune varchar(50), @document xml)
as 
begin
	declare @DateSalGrpPeLMNivel1 int, @data datetime, @marca varchar(6), @lmantet varchar(9), @lmsal varchar(9), @Plecat int, @Data_plec datetime, @mesaj varchar(200)
	...
	if @document.exist('/row/row')=1 and @lmsal<>@lmantet and @DateSalGrpPeLMNivel1=0
	begin
