...
DECLARE @cod VARCHAR(20), @descriere VARCHAR(80), @formula VARCHAR(1000), @procent BIT, @valoare FLOAT, @parinte VARCHAR(20), @update 
	BIT, @pas INT, @cvaloare VARCHAR(20)
...
BEGIN
	...
	BEGIN
		RAISERROR ('(wScriuElementeAntec)Cod sau descriere asociate deja altui element!', 11, 1)
...
ELSE
	...
	BEGIN
		...
		BEGIN
			...
			RAISERROR ('(wScriuElementeAntec)Nu este permisa modificarea codului. Restul modificarilor s-au salvat!', 11, 1
					)
		END
