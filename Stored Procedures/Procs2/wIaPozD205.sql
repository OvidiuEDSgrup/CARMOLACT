...
Begin
	...
	convert(decimal(10),d.Venit_brut) as venitbrut, convert(decimal(10),d.Deduceri_personale) as dedpers, convert(decimal(10),d.Deduceri_alte) as dedalte, 
	convert(decimal(10),d.Baza_impozit) as bazaimpozit, convert(decimal(10),d.Impozit) as impozit, convert(decimal(10),d.venit_net) as venitnet, 
	'#000000' as culoare 
	from DateD205 d 
