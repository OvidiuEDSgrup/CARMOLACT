...
declare @subunitate char(9), @data datetime , @cdeb char(13), @ccre char(13), @suma float,
@lmV char(9), @comandaV char(20), @articolV char(13),   
@lmN char(9), @comandaN char(20), @articolN char(13),
@numar char(13), @Utilizator char(10), @binar varbinary(128), @err int
--
exec luare_date_par 'GE', 'SUBPRO', 0, 0, @subunitate output        
set @data=ISNULL(@parXML.value('(/parametri/@data)[1]', 'datetime'), '')      
set @cdeb=ISNULL(@parXML.value('(/parametri/@cdeb)[1]', 'char(13)'), '')      
set @ccre=ISNULL(@parXML.value('(/parametri/@ccre)[1]', 'char(13)'), '') 
