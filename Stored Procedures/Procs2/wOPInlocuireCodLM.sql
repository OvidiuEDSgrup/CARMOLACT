		...
		begin try		
			...
			alter table PozInCon disable trigger all
				...
				select		
					...
					Numar_pozitie, Loc_de_munca, Comanda, max(Jurnal),indbug
				from #tmppozincon
				group by Subunitate, Tip_document, Numar_document, Data, Cont_debitor, Cont_creditor, Loc_de_munca, Comanda, Valuta, indbug,Numar_pozitie
			...
			alter table rulaje disable trigger all
				...
				(
					select 
						r.subunitate, r.cont, r.loc_de_munca, r.valuta, r.data, c.tip_cont,r.indbug,
				...
				) rtmp on rl.subunitate=rtmp.subunitate and rl.cont=rtmp.cont and rl.loc_de_munca=rtmp.loc_de_munca and rl.valuta=rtmp.valuta and rl.data=rtmp.data and rtmp.tip_cont=c.tip_cont and rtmp.indbug=rl.indbug
