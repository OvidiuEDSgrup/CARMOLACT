...
BEGIN TRY
	...
	if exists (select 1 from sysobjects where NAME = 'wOPPreluareContributiiInOrdineDePlataSP1')
		exec wOPPreluareContributiiInOrdineDePlataSP1 @sesiune=@sesiune, @parXML=@parXML
