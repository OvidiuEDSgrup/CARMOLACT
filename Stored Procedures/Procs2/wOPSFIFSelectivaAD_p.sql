...
BEGIN TRY
	DECLARE @tert VARCHAR(20), @mesaj VARCHAR(400), @dataJos DATETIME, @dataSus DATETIME,
		...
		@cotatva decimal(12,2), @tiptva int, @date xml, @cotatva_std decimal(12,2) 

	EXEC wIaUtilizator @sesiune = @sesiune, @utilizator = @utilizator OUTPUT

	EXEC luare_date_par 'GE', 'SUBPRO', 0, 0, @sub OUTPUT --> citire subunitate din par
	...
	SET @cotatva = isnull(@parXML.value('(/*/*/@cotatva)[1]', 'decimal(12,2)'),@cotatva_std)
