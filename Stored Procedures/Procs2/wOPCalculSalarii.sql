...
begin try  
	...
	set @parXMLValidari=(select convert(char(10),@datajos,101) as datajos, convert(char(10),@datasus,101) as datasus, 'CE,SI,DP,PE,NP,SN,PI,' as tipvalidare for xml raw)
...
begin catch  
	...
	set @eroare='(wOPCalculSalarii) '+rtrim(ERROR_MESSAGE())
