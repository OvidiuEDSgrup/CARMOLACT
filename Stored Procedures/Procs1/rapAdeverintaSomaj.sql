...
begin try 
	...
	if exists (select * from sysobjects where name ='rapAdeverintaSomajSP')
		exec rapAdeverintaSomajSP @sesiune=@sesiune, @marca=@marca, @datajos=@datajos, @datasus=@datasus, @dataset=@dataset, @parXML=@parXML, @nrluni=@nrluni
