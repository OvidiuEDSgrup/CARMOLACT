...
begin try
	...
	create table #decontvanz (numar char(20))
	exec CreazaDiezTVA '#decontvanz'
...
--	exec Declaratia300Vanzdet @parXML
	...
	insert into #decontvanz
		...
		explicatii, detal_doc, care_jurnal, tip_doc, nr_doc, data_doc, valoare_doc, suma_tva_doc, baza_19_reg, tva_19_reg)
	select d.numar, d.data, d.cod_tert, d.beneficiar, d.codfisc, convert(decimal(15,3),d.total) as total, 
		convert(decimal(15,3),d.baza_19+d.baza_txinv_cump)-convert(decimal(15,3),d.baza_19_reg) as baza_19, convert(decimal(15,3),d.tva_19+d.tva_txinv_cump)-convert(decimal(15,3),d.tva_19_reg) as tva_19,
		...
		convert(decimal(15,3),d.baza_19_reg) as baza_19_reg, convert(decimal(15,3),d.tva_19_reg) as tva_19_reg
	from #jtvavanz d
...
*/
	...
	insert into #dectvavanz 
		(total, baza_19, tva_19, baza_9, tva_9, baza_5, tva_5, baza_txinv, tva_txinv, regim_spec, afara_ded, afara_ded_serv, afara_fara,
			scutite_intra_ded_1, scutite_intra_ded_2, scutite_ded_alte, scutite_fara, neimpozabile, valoare_doc, suma_tva_doc, baza_19_reg, tva_19_reg)
	select isnull(convert(decimal(15),sum(total)),0) as total, 
		...
		isnull(convert(decimal(15),sum(baza_19_reg)),0) as baza_19_reg, isnull(convert(decimal(15),sum(tva_19_reg)),0) as tva_19_reg
	from #decontvanz
