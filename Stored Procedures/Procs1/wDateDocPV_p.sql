...
begin try
	...
	begin
		...
		if isnull(@comanda,'')!=''
			select top 1 @LM=loc_de_munca /*, @comandaASiS= de facut*/ from con where subunitate='1' and tip='BK' and Contract=@comanda /*-- nu merge and (@cDataComenzii is null or Data=convert(datetime,@cDataComenzii,103))*/
			order by data desc
