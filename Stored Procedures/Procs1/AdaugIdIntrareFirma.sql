...
begin try
	...
	if @wscriudoc=0	and @wscriudocbeta=0
		return
/*Daca cineva vrea sa il foloseasca trebuie sa stearga return-ul de mai jos
!!!Atentie se pot strica datele ireversibil
			...
			select 
				...
				(
					select 
						...
						rtrim(cont) as contstoc,cod_intrare as codintrare,rtrim(locatie) as locatie,
