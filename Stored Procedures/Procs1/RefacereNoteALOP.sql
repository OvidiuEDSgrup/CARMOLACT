...
begin try 
	...
	declare @Sb char(9), @TipNCAlop char(2), @Ct8066 varchar(40), @Ct8067 varchar(40), @docPozncon xml, @parXMLfaInreg xml
	...
	set @parXMLfaInreg=(select 4 as tabela for xml raw)
	exec fainregistraricontabile @dinTabela=2, @parXML=@parXMLfaInreg
end try
