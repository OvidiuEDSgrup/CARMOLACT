...
Create
procedure  pCalcul_spor_conditii
	@DataJ datetime, @DataS datetime, @MarcaJos char(6), @MarcaSus char(6), @LocmJos char(9), @LocmSus char(9), @Ore_luna float, @OreM_luna float, 
	@ScadOS_RN int, @ScadO100_RN int, @NuSpc_OIT float, @Sp1_suma int,@Sp2_suma int,@Sp3_suma int, @Sp4_suma int,@Sp5_suma int, @Sp6_suma int, @Sp1_oreg int, @Sp2_oreac int, 
	@Spc_sumafixa int, @Sp6_proc_suma int, @Suma_bazasp6 float, @Sp6_oreluna int, @Spc_O100 int, @Sp1_sumazi int, @Plata_ora int, 
	@Pasmatex int, @Drumco int, @Salubris int, @DSVET int, @ARLCJ int, @Gencom int, @Drumor int, @Term char(8) 
As
Begin
/*
...
*/
	...
	Begin
		Create table dbo.##brut_spc (Terminal char(8), Data datetime, Marca char(6), Loc_de_munca char(9), Spor_cond_1 float, Spor_cond_2 float, Spor_cond_3 float, 
		Spor_cond_4 float, Spor_cond_5 float, Spor_cond_6 float)
