...
begin try
	...
	begin
		...
		exec rapRegistruPlatiIncasari_faTabela
	end
	...
	insert into #rapRegistruPlatiIncasari_Tabela(subunitate, data, plata_incasare, numar, explicatii, incasari, plati, cont)
	...
	if @cuTabela=0 select * from #rapRegistruPlatiIncasari_Tabela
end try
begin catch
