--***
create procedure [dbo].[wACNomenclatorRS] @sesiune varchar(50),@parXML XML      
as
...
where (rtrim(nomencl.denumire) like '%'+@searchText+'%' or nomencl.cod like @searchText+'%' or nomencl.cont like '%'+@searchText+'%')
...
select rtrim(nomencl.cod) as cod, 
	...
	rtrim(nomencl.denumire)+' ('+rtrim(nomencl.cont)+')' as denumire 
