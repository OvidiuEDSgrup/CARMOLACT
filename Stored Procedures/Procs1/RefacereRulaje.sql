...
as
-- exec RefacereRulaje @dDataJos ='2016-08-01', @dDataSus ='2016-08-31', @cCont =null, @nInLei =1, @nInValuta =0, @cValuta =null
...
IF @dDataJos<@dDataJosRecalc
BEGIN
	declare @err varchar(2000)
	set @err='Data refacerii ('+convert(char(10),@dDatasus,103)+') este inferioara datei implementarii ('+convert(char(10),@ddataimpl,103)+')!'
	RAISERROR(@err,16,1)
	return
END
