...
begin
	...
	isnull(p.nr_contract,ip.nr_contract) as numar_contract, isnull((select max(data_inf) from extinfop e where e.marca=p.marca and e.cod_inf='DATAINCH'),p.data_angajarii_in_unitate) as data_contract, 
