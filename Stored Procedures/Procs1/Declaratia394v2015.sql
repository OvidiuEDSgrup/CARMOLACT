...
*/
Create procedure Declaratia394v2015
...
--	In cazul cerealelor documentele de tip SF/IF se vor opera prin RM/AP pe cod de tip serviciu care va avea atasat un cod de Nomenclatura combinata pt. cereale
	...
	begin
		...
		select codtert,codfisc,dentert,tipop,nrfacturi,baza,tva,codNomenclator, invers from dbo.rapTVAUAPlus2015(@datajos,@datasus) 
	end
	...
	begin
		exec Declaratia394UA2015 @DataJos=@datajos,@DataSus=@datasus,@sesiune=@sesiune
	end
...
begin catch
	set @eroare=ERROR_MESSAGE()+' (Declaratia394v2015)'
end catch
