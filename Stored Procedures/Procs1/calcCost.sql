--***
create procedure calcCost @datajos datetime='2014-01-01',@datasus datetime='2014-01-31' as 
-- exec calcCost
...
exec insertchelt @datajos,@datasus
...
exec calculcost @datajos,@datasus
...
exec inserezcoststandard @datajos,@datasus
...
execute repAdmDesf @datajos,@datasus
...
exec inlocPretNotaDif @datajos,@datasus
...
exec InsertFisaPeCont @datajos,@datasus
set nocount off
