...
begin
	...
	if isnull((select max(cont_parinte) from conturi where subunitate=@cSub and cont=@cCont), '')=@cCont
	begin
		declare @errmsg varchar(200)
		set @errmsg='Contul '+@cCont+' nu are parinte bine declarat (AdaugInRulaje)'
