--***
Create procedure rapListaLichRet 
	@DataJ datetime, @DataS datetime, @oMarca int, @Marca char(6), @unLm int, @Lm char(9), @Strict int, @Centralizat char(1)='S', @NivelCentr int=0, @DetTipRet int=1
as
begin
