--***
create procedure SitComparativa(@dDataJos datetime, @dDataSus datetime, @cLM char(9), @cComanda char(20),@Terminate int, @Facturate int, 
	@GrupaCom char(20), @ArtCalc varchar(300), @ArtCalcExcep varchar(300),@lExact int,@beneficiar char(13) =null, 
