...
as
declare @ore_realcom int, @nrcom int, @salariatiPeComenzi int

select @SalariatiPeComenzi = (case when Tip_parametru='PS' and parametru='SALCOM' then Val_logica else @SalariatiPeComenzi end)
from par
where Tip_parametru='PS' and Parametru in ('SALCOM')
