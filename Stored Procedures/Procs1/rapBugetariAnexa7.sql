...
--***
create procedure rapBugetariAnexa7 (@datajos datetime,@datasus datetime,@prefix varchar(40),@ign_pb nvarchar(1),@grupa varchar(20), 
...
set @nivCent=(case when isnull(@nivCent,'')='' then '4,8,10,12,14,16' else @nivCent end)
