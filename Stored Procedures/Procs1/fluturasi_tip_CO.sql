...
Begin
	...
	select a.Marca, (case when a.Tip_concediu in ('1','7') then 'CO-Anual' when a.Tip_concediu in ('4','8') then 'CO-Anual an ant.' 
		when a.Tip_concediu in ('2','E')  then 'CO-Eveniment' when a.Tip_concediu='5'  then 'Chemare-CO' 
	...
	where a.Data between @datajos and @datasus and a.Marca=@pmarca and a.Tip_concediu in ('1','2','E','3','4','5','6','7','8')
