--***
create procedure inserezcoststandard @datajos datetime,@datasus datetime 
as 
...
select 
@subunitate,tip,left(numar,8),max(data),sum(cantitate*valoare),'',lm_sup,comanda_sup,art_inf,comanda_inf,lm_inf,comanda_inf
from costtmp where comanda_sup='' and art_sup not in ('P','R','S','N') 
