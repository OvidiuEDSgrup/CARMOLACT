...
CREATE PROCEDURE updateStareContractSP @sesiune VARCHAR(50), @parXML XML
AS
...
BEGIN CATCH
	SET @mesaj = ERROR_MESSAGE() + ' (updateStareContractSP)'

	RAISERROR (@mesaj, 11, 1)
END CATCH

-- exec updateStareContractSP '', '<row idContract="220" />'