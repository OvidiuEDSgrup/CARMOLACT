--***
Create procedure wACCategorieAngajator @sesiune varchar(50), @parXML XML
as
Begin
	...
	from CatalogRevisal
	where TipCatalog='CategorieAngajator' and (cod like @searchText+'%' or descriere like '%'+@searchText+'%')
	order by cod
	for xml raw
End	