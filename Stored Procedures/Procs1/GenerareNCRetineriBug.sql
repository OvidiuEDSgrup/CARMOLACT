...
begin try
	...
	if exists (select * from sysobjects where name ='GenerareNCRetineriBugSP1')
		exec GenerareNCRetineriBugSP1 @dataJos=@dataJos, @dataSus=@dataSus, @pMarca=@pMarca, @Continuare=@Continuare output, @NrPozitie=@NrPozitie output, @NumarDoc=@NumarDoc
