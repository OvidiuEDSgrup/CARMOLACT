...
Begin
	...
	@Salar_orar float, @Regim_de_lucru float, @COEV_macheta int, @MachetaCO int, @MachetaCO_TipOpMach varchar(100)
	...
	where data between @dataJos and @dataSus and a.Marca<>'' and a.Tip_concediu not in ('9','C','P','V')
		...
		and (@MachetaCO=1 or charindex(a.tip_concediu,@MachetaCO_TipOpMach)<>0)
