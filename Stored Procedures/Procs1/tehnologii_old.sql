...
--***
create procedure [dbo].[tehnologii_old](@tehn varchar(20),@tip varchar(20),@catsal char(4),@evid_inloc int,@evid_mat int,@cHostid char(8) output, @tipdoc char(2), @nrdoc char(20), @datadoc datetime)
As
Begin
