...
Create procedure [dbo].[rapPersIntr]
	...
	@datacopil18 datetime=null, @dataexpdedJos datetime=null, @dataexpdedSus datetime=null, @ordonarelm int=1, @nivel int=0, 
	@tipraport char(1)='N', @coasigurati int=0
as
/*
...
--		and (@marca is null or b.marca=@marca) 
		...
		and (@coasigurati=0 or b.Tip_intretinut in ('S','R','I'))
