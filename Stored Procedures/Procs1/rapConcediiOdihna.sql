		...
		Begin
			...
			Begin
				...
				if @GrupaMunca not in ('O','P') and @Tip_colab<>'FDP' and @CalcCONetFDP=0
					exec calcul_deducere @venitBrut=@VenitCO, @nrPersIntr=@NrPersintr, @dedPers=@DedBaza output, @venitBrutCuDed=@venitBrutCuDed, @venitBrutFaraDed=@venitBrutFaraDed, @data=@data
