...
As
Begin try
	declare @Ore_luna float, @OreM_luna float, @Ore_luna_tura float, @Suma_comp float, @MachetaCO int, @MachetaCO_TipOpMach varchar(100), @CO_pontaj int, 
...
--	parametrii 
	...
	ind_concediu_de_odihna=(case when @CO_pontaj=0 or @MachetaCO=1 then 0 
		...
		+@Sp2_co*(case when @Sp2_suma=1 then 0 else p.spor_conditii_2 end)+@Sp3_co*(case when @Sp3_suma=1 then 0 else p.spor_conditii_3 end)
		+@Sp4_co*(case when @Sp4_suma=1 then 0 else p.spor_conditii_4 end)+@Sp5_co*(case when @Sp5_suma=1 then 0 else p.spor_conditii_5 end)
		+@Sp6_co*(case when @Sp6_suma=1 then 0 else p.spor_conditii_6 end)+@Sp7_co*isnull(isnull(p.spor_cond_7,ip.Spor_cond_7),0)
...
--	Am mutat apelul procedurii scriu_brut_din_CO in procedura pCalcul_salarii_realizate
