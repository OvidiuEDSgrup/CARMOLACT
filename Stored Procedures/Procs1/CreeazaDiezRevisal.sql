...
Begin
	alter table #RevisalContracte
		...
		TextTemeiIncetare varchar(100), DetaliiContract varchar(500), DataIncheiereContract datetime, StareCurenta varchar(50), 
...
Begin
	...
	Begin
		alter table #extinfop
			add Cod_inf char(13) not null, Val_inf nvarchar(500) not null, Data_inf datetime not null, Procent float not null
