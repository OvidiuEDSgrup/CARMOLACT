...
--	verific luna inchisa
	...
	Select a.data, a.marca, a.tip_concediu, a.Data_inceput, a.Data_sfarsit, a.Zile_CO, a.Introd_manual, 
		...
		p.Tip_colab, isnull(isnull(p.detalii.value('(/row/@functpublic)[1]','int'),convert(int,ip.Actionar)),0), i.Salar_de_baza, isnull(c.Data,''), isnull(c.Suma_corectie,0), isnull(d.Data_inceput,''), 
