...
Begin
	...
	@CandScriu int, @ore char(20),@cSomajInd char(10),@nValTichet float, @ImpozitTichete int, @denImpozitIpotetic varchar(50), @denImpozit varchar(50)
	...
	from tmpfluturi a
		...
		left outer join #ptichete t2 on @ImpozitTichete=1 and a.Marca=t2.Marca /*a.Data=t2.Data*/
