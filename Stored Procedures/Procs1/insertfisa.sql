--***
create procedure insertfisa @pLm char(13),@pCom char(13),@pNivel int,@pNivelMax int,@pCantPond float,@pArtSup char(13),@pExceptArtSup char(13),@pExcArtNeincl char(13),@pArtInf char(13),@pDetalDOC int,@pSub char(13),@pDinf datetime,@pDsup datetime,@pGrCom 
...
begin    
 ...
 CREATE TABLE #f1([Numar_de_ordine] int identity,[Nivel] [smallint],[Descriere] [char](100),[Cantitate] [float],[Pret] [float],[Valoare] [float],
	[Tip] [char](1),[Cod] [char](20),[Locm] [char](9),[Comanda_sup] [char](13),[Art_sup] [char](9),[NrOrdP] [int])  
