...
--	iau numarul maxim deja generat (pt. cazurile in care se ruleaza operatia cu filtre) pentru a putea numerota la rand numerele de document
	...
	select a.decont,a.data,a.data_scadentei,a.marca,a.cont,a.valuta,a.curs as curs_decont,a.sold_valuta,a.sold,a.loc_de_munca,a.comanda,b.curs as curs_la_data, 
	...
	a.Valuta,a.curs_la_data,0,0,0,0,'Dif. curs decont '+rTrim (a.Decont),a.Loc_de_munca,a.Comanda,@user,convert(datetime, convert(char(10), getdate(), 104), 104),
