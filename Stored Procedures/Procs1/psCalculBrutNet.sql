...
Begin
	...
	@Compexit int, @Data datetime, @Marca char(6), @Loc_de_munca char(9), @Tip_corectie_venit char(2), @Tip_corectie char(2), 
...
*/
	...
	exec pTichete @dataJos=@DataImpTicJ, @dataSus=@DataImpTicS, @marca=@MarcaJ, @DeLaCalculLichidare=1

	declare CalculBrutNet cursor for
	select a.Data, a.Marca, a.Loc_de_munca, a.Tip_corectie_venit, (case when @subtipcor=1 then st.Tip_corectie_venit else a.Tip_corectie_venit end) as tip_corectie, 
		a.Suma_corectie, a.Procent_corectie, a.Suma_neta, 
	...
	from corectii a 
		...
		left outer join #ptichete t on @ImpozitTichete=1 and a.Marca=t.Marca /*t.Data=@dataSus*/
		left outer join dbo.fSumeCorectie (@dataJos, @dataSus, 'Q-', @MarcaJ, '', 0) q on q.Data=a.Data and q.Marca=a.Marca 
		left outer join subtipcor st on st.subtip=a.tip_corectie_venit and @subtipcor=1
	...
	open CalculBrutNet
	fetch next from CalculBrutNet into @Data, @Marca, @Loc_de_munca, @Tip_corectie_venit, @Tip_corectie, @Suma_corectie, @Procent_corectie, 
...
*/	
		exec psBuclaBrutNet @dataJos, @dataSus, @Data, @Marca, @Loc_de_munca, @Precizie, @Tip_corectie_venit, @Tip_corectie,
		...
		fetch next from CalculBrutNet into @Data, @Marca, @Loc_de_munca, @Tip_corectie_venit, @Tip_corectie, @Suma_corectie, 			
