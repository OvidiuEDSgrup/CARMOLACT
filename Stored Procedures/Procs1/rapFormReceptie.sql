...
*/
	...
	create table [dbo].[#PozDocFiltr] ([Numar] [varchar](20) NOT NULL, [Cod] [varchar](20) NOT NULL, [Data] [datetime] NOT NULL, 
		...
		[Locatie] varchar(100), [Data_expirarii] datetime, lot varchar(100), cotatva decimal(15,2))

	insert into #PozDocFiltr (Numar, Cod, Data, Gestiune, Cantitate, Cantfactura, Pret_valuta, Pret_de_stoc, 
		TVA_deductibil, Tert, Factura, Data_facturii, numar_pozitie, utilizator, Comanda, detalii, Locatie, Data_expirarii, lot, cotatva)
	select 
		...
		rtrim(pz.Comanda), pz.detalii, rtrim(pz.Locatie), pz.Data_expirarii, pz.lot, pz.cota_tva
	from pozdoc pz
	...
	select 
		...
		isnull(p2.lot,p2.cod_intrare), p2.detalii, rtrim(p2.Locatie), p2.Data_expirarii, pz.lot, pz.cota_tva
	from pozdoc pz
		inner join #filtre f on f.subunitate=pz.subunitate and f.tip=pz.tip and f.data=pz.data and f.numar=pz.numar
