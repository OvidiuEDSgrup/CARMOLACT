...
Begin
	...
	@lOZCMMP int, @cOZCMMP char(1), @COEV_macheta int, @lFLDTIPCO int, @INDC_suma int, @ore char(20), @cand_scriu bit
	...
	Begin
		...
		End
		if @Ind_obl_cet<>0 and (@COEV_macheta=0 or @lFLDTIPCO=0)
		Begin
		...
		End
		if (@Ore_co<>0 or @Ind_co<>0 or @COEV_macheta=1 and @Ind_obl_cet<>0) and @lFLDTIPCO=1
		Begin
