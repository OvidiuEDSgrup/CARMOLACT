...
*/
	...
	set @parXML=(select @cFurnBenef as furnbenef, '01/01/1921' as datajos, convert(char(10),@dData,101) as datasus, 1 as cen, rtrim(@cTert) as tert, rtrim(@cFactura) as factura, 1 as refacere for xml raw)
