...
BEGIN TRY
	...
	if @doarStergere=0
	begin
		/*	Pentru ASiSplus am pastrat varianta anterioara. Pot fi cazuri in care sunt diferente intre analitic si sintetic. 
			Prin preluare cu pRulajeConturi soldurile pe sintetic se recalculeaza din analitice si se dezechilibreaza balanta.
		*/
		if charindex('unipaas', APP_NAME())>0
		begin
