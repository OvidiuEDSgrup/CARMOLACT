...
begin try
	...
	declare @multiFirma int, @lmUtilizator varchar(20), @userASiS varchar(20)
	...
	declare @ctavansfurn varchar(40), @ctavansben varchar(40), @nrptnrdoc int, @nrpozitie int, @IFN int, @faradifcursbenIFN int, @sifactinvalutaIFN int,
		...
		@ctexceptie varchar(40), @gtert char(13), @inversare_ordine_comp_fact int
