--***
create procedure [dbo].[insertfisa2] @pLm char(13),@pCom char(13),@pNivel int,@pNivelMax int,@pCantPond float,@pArtSup char(13),@pExceptArtSup char(13),@pExcArtNeincl char(13),@pArtInf char(13),@pDetalDOC int,@pSub char(13),@pDinf datetime,@pDsup datetime,@pGrCom int,@pComenziNedet char(100),@pArtCalcNedet char(100),@pNrOrd int
as 
begin 
declare @cDesc char(100),@nCant float,@nPret float,@nValoare float,@nNivelUrm int,@nFetch int,@cLm char(13),@cComanda char(13),@cNume char(100),@nCantPond float,@cArticol char(13) ,@subunitate char(9)
declare @cTip char(2),@cNumar char(13),@dData datetime,@cCont char(13),@nLm int,@cComDinGr char(13),@cComAnt char(13),@cTip_descriere char(1),@cCod_descriere char(20),@cLocM_descriere char(9),@nLuna int,@nAn int 
declare @lSCom int,@lSLM int,@nNrOrd int,@nNrPar int,@nNrPar1 int,@cNrOrd int,@dDJos datetime,@dDSus datetime,@dDatatmp datetime,@gArticol char(13) 
declare @tt table(lm_sup char(13),comanda_sup char(13),art_sup char(13),art_inf char(13),numar int identity) 
set @lSCom=1 
set @lSLM=1 
