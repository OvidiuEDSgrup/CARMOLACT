...
CREATE PROCEDURE [dbo].[wIaAntecalculatii] @sesiune VARCHAR(50), @parXML XML
AS
DECLARE @fltCod VARCHAR(20), @fltPretJos FLOAT, @fltPretSus FLOAT, @fltDenumire VARCHAR(80), @fltNumarDoc VARCHAR(10), @datajos 
...
SELECT TOP 100 RTRIM(a.cod) AS cod, RTRIM(n.denumire) AS denumire, convert(CHAR(10), a.data, 101) AS data, CONVERT(DECIMAL(12, 5), a.
