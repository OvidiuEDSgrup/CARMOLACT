...
--	calcul sume aferente timpului nelucrat
	...
	if exists (select * from sysobjects where name ='CalculVenitTotalSP1')
		exec CalculVenitTotalSP1 @datajos=@datajos, @datasus=@datasus, @marca=@marca, @lm=@lm, @din_inversare=@din_inversare
