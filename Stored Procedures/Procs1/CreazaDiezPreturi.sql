...
AS
	...
	alter table #preturi 
		add pret_vanzare decimal(12,5), discount decimal(12,5), pret_amanunt decimal(12,5), 
			...
			valuta varchar(6),curs decimal(12,5),tipPret char(1),calculat int default 0,pret_vanzare_vechi decimal(12,5),pret_amanunt_vechi decimal(12,5),inpromotie int, tipPretCategorie int
	/*
		...
		tipPretCategorie reprezinta tipul de pret din cadrul categoriei (
			1 'Pret standard' 
			2, 'Pret promo data'
			3, 'Pret promo ora' 
			9, 'Pret impus'

			vezi functia fTipPret
