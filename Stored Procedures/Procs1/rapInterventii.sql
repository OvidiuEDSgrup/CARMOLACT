...
set @parametri='<row '+(case when @DataJos is null then '' else 'datajos="'+convert(varchar(20),@DataJos,101)+'" ' end)+
					...
					+(case when @Masina is null then '' else 'codMasina="'+convert(varchar(20),@Masina,101)+'" ' end)+
					+(case when @TipInterventie is null then '' else 'tipinterventii="'+convert(varchar(20),@TipInterventie,101)+'" ' end)+
					+(case when @Element is null then '' else 'element="'+convert(varchar(20),@Element,101)+'" ' end)+
