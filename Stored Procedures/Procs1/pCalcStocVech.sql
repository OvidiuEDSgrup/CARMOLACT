Create procedure [dbo].[pCalcStocVech] @parDRef datetime, @parSub char(9), @parTipGest char(1), @parGest char(9), @parCod char(20),@i1 int , @i2 int , @i3 int , @i4 int, @zileDif int, 
...
Select data,pret,stoc_ce_se_calculeaza from stocuri 
