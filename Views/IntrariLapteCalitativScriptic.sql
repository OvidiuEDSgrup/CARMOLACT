CREATE VIEW [dbo].[IntrariLapteCalitativScriptic] AS
SELECT 
p.Subunitate,
p.Tip, 
p.Numar,
...
dbo.iauPropStocGestCodIntr(identificator, 'G') AS gras_scriptic,
dbo.iauPropStocGestCodIntr(identificator, 'G')*p.cantitate AS cant_UG_scriptic,

dbo.iauPropStocGestCodIntr(identificator, 'S') AS subst_scriptic,
dbo.iauPropStocGestCodIntr(identificator, 'S')*p.cantitate AS cant_US_scriptic,

dbo.iauPropStocGestCodIntr(identificator, 'D') AS dens_scriptic,
dbo.iauPropStocGestCodIntr(identificator, 'D')*p.cantitate AS cant_UD_scriptic,

dbo.iauPropStocGestCodIntr(identificator, 'A') AS apa_scriptic,
dbo.iauPropStocGestCodIntr(identificator, 'A')*p.cantitate AS cant_UA_scriptic,

dbo.iauPropStocGestCodIntr(identificator, 'P') AS prot_scriptic,
dbo.iauPropStocGestCodIntr(identificator, 'P')*p.cantitate AS cant_UP_scriptic,
...
FROM pozdoc p 
	INNER JOIN TipLapte tl ON p.cod=tl.cod
