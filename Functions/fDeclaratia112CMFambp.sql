--***
Create
function fDeclaratia112CMFambp 
...
Begin
	...
	where a.data between @DataJ and @DataS and a.data_inceput between @DataJ and @DataS 
		and (@oMarca=0 or a.marca=@Marca) and (@Lm='' or i.loc_de_munca like rtrim(@Lm)+(case when @Strict=0 then '%' else '' end)) 
