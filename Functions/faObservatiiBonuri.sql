...
CREATE FUNCTION faObservatiiBonuri (@factura varchar(50),@data datetime)
...
BEGIN
	...
	select @obs = isnull(( select observatii from antetBonuri where factura=@factura and data_facturii=@data and chitanta=0 ),'')
