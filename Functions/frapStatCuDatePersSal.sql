...
returns @date_personal table
	(marca char(6),nume char(50),cod_functie char(6),denumire_functie char(100),loc_de_munca char(9), denumire_locm char(30), grupa_de_munca char(1), categoria_salarizare char(4), 
	salar_de_incadrare int, indemnizatia_de_conducere int, tip_stat char(10), data_angajarii_in_unitate datetime, data_plec datetime, profesia char(10), studii char(10), salar_orar float, 
...
--	verific daca utilizatorul are/nu are dreptul de Salarii conducere (SALCOND)
	...
	select a.marca, a.nume, a.cod_functie, a.denumire_functie, a.loc_de_munca, a.denumire_locm, a.grupa_de_munca, a.categoria_salarizare, 
		a.salar_de_incadrare, a.indemnizatia_de_conducere, a.tip_stat, a.data_angajarii_in_unitate, a.data_plec, a.profesia, a.studii, convert(decimal(10,3),a.salar_orar) as salar_orar, 
	...
	(select p.marca,isnull(i.Nume,p.nume) as Nume,isnull(i.cod_functie,p.cod_functie) as cod_functie, f.denumire as denumire_functie, isnull(i.loc_de_munca,p.loc_de_munca) as loc_de_munca, lm.denumire as denumire_locm,
		...
		isnull(i.indemnizatia_de_conducere,p.indemnizatia_de_conducere) as indemnizatia_de_conducere, isnull(p.tip_stat,ip.Religia) as tip_stat,
		p.data_angajarii_in_unitate, p.data_plec, p.profesia, p.studii, p.salar_orar, p.pensie_suplimentara, p.spor_cond_7, 
		...
		round(d.sal_inc_calc*isnull(p.spor_cond_7,ip.spor_cond_7)/100,0) as sp7_calc,
