...
as begin
	...
	if exists (select 1 from doc where subunitate=@Sub and tip in ('AP', 'AS') and cod_tert=@Tert and 
	gestiune_primitoare=@PunctLivrare)
		return 1
	return 0
end


--select dbo.wfRefPuncteLivrare('108627','P060')    
