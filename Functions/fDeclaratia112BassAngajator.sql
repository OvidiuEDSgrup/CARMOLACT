--***
Create
function fDeclaratia112BassAngajator 
...
Begin
	...
	from net n
		...
		left outer join dbo.fDeclaratia112Scutiri (@DataJ, @DataS, 1, @lm) s on s.data=n.data and s.marca=n.marca
	where n.data=@DataS	and (@lm='' or i.Loc_de_munca like rtrim(@lm)+'%')
	group by n.data
