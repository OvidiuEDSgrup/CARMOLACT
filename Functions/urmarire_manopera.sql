...
--***
create function urmarire_manopera (@datajos datetime,@datasus datetime,@ord int,@inchise int,@simulare int,@com char(20),@sircom char(50),@reper char(20),@lm char(20),@oper char(20),@marca char(20),@evidreal int,@datajosr datetime,@datasusr datetime,@tipl int,@sub char(20))
