...
Create
function  fAngajari (@TipRaport char(50), @DataJos datetime, @DataSus datetime, @oMarca int, @Marca char(6), @oFunctie int, @Cod_functie char(6),@unLocm int, @Loc_de_munca char(9), @Strict int, @unTipPersonal int, @TipPersonal char(1), 
