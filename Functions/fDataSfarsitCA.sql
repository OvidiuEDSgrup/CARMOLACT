...
begin
	...
	isnull((select count(1) from conalte b where b.Data>=@pData and b.marca=@pMarca and (@Tip_concediu='' or b.Tip_concediu=@Tip_concediu)  
	...
	where a.marca=@pMarca and a.data_inceput>=DateAdd(day,1,@pData_sfarsit)
		...
		and exists (select marca from conalte b where b.Data>=@pData and b.marca=@pMarca and (@Tip_concediu='' or b.Tip_concediu=@Tip_concediu)  
